...
import 'package:test_flutter/presentation/pages/no_login_aleat_dialog.dart';
...
class NoLoginPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: const Padding(child: MediumAdBanner(),padding: EdgeInsets.all(30.0),),
      body: ListView(
        children: [
          for(int i = 0; i < 2; i++)
         Card(
